package com.zhiyi.community.model;

import java.io.Serializable;
import java.util.Date;

public class DeliveryCommunity implements Serializable{

    private static final long serialVersionUID = -1370528226489786467L;
