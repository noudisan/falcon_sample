...
<div id="dialog-edit-pwd" class="hide">
    <form id="edit-pwd-form" class="form-horizontal" role="form"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <div style="margin-top: 5px;">
                    ...
                    <input type="hidden" name="userName" id="userName" value="<shiro:principal type="java.lang.String"/>"/>
                </div>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-4 control-label col-xs-12  no-padding-right" for="password">原密码*:</label>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label col-xs-12  no-padding-right" for="confirmNewPassword">确认新密码*:</label>
